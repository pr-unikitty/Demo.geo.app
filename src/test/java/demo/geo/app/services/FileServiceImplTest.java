...
public class FileServiceImplTest {
    ...
    public void setUp() throws FileNotFoundException {
        fileService = new FileServiceImpl(sectionRepository, jobRepository, sectionService);
        file = new File(FULL_FILE_NAME);
        job = new Job(JType.EXPORT, JStatus.IN_PROGRESS, LocalDateTime.now());
        job.setId(1L);
